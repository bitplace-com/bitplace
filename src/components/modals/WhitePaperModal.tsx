      ...
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-2 text-sm text-muted-foreground">
            <p>
              Pixel Balance pixels are temporary — they expire after <span className="text-foreground font-medium">72 hours</span> and anyone can paint over them for free. But you can keep them alive: repaint before expiry and the <span className="text-foreground font-medium">72h timer resets</span>. When a pixel expires or is painted over, it returns to your budget.
            </p>
            <p>
