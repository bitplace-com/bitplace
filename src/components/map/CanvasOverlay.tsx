...
interface CanvasOverlayProps {
  ...
  rectPreview?: { start: { x: number; y: number }; end: { x: number; y: number } } | null;
}
...
export function CanvasOverlay({
  ...
  }, [map, pixels, selection, hoverPixel, canPaint, invalidPixels, artOpacity, mode, modeColors, brushSelectionPixels, previewHiddenPixels, draftPixels, inspectBrushSelectionPixels, isInspectSelecting, rectPreview]);
