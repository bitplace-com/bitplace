  ...
  if (isMobile) {
    return (
      <Drawer open={open} onOpenChange={onOpenChange}>
        <DrawerContent className="max-h-[85vh] glass-hud-strong">
          <DrawerHeader className="pb-2">
            <div className="flex items-center gap-3">
              ...
              <DrawerClose className="rounded-full p-2 hover:bg-foreground/10 transition-colors">
                <X className="h-5 w-5" />
                <span className="sr-only">Close</span>
              </DrawerClose>
            </div>
          </DrawerHeader>
          <div className="flex-1 overflow-y-auto px-4 pb-safe-bottom pb-6">
            {children}
          </div>
        </DrawerContent>
      </Drawer>
